...
class supplierClass:
    def __init__(self, root):
        ...
        # ---------- Search Frame -------------
        lbl_search = Label(
            self.root, text="Invoice No.", bg="white", font=("goudy old style", 15)
        )
        ...
        lbl_supplier_invoice = Label(
            self.root, text="Invoice No.", font=("goudy old style", 15), bg="white"
        ).place(x=50, y=80)
        ...
        # ---------- row 4 ----------------
        lbl_desc = Label(
            self.root, text="Description", font=("goudy old style", 15), bg="white"
        ).place(x=50, y=200)
    ...
    def search(self):
        try:
            if self.var_searchtxt.get() == "":
                ...
                if rows:
                    self.supplier_table.delete(*self.supplier_table.get_children())
                    self.supplier_table.insert("", END, values=rows[0])
                else:
                    messagebox.showerror(
